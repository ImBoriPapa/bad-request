...
=== 회원가입
----
GET: http://www.bad-request.kr/api/v1/members
----
==== 요청
...
----
GET: http://www.bad-request.kr/api/v1/members/email
----
==== 요청
...
----
GET: http://www.bad-request.kr/api/v1/members/auth
----
==== 요청
...
=== 연락처 변경
----
PATCH: http://www.bad-request.kr/api/v1/members/{memberId}/contact
----
==== 요청
...
=== 비밀번호 변경
----
PATCH: http://www.bad-request.kr/api/v1/members/{memberId}/password
----
==== 요청
...
=== 회원 탈퇴
----
DELETE: http://www.bad-request.kr/api/v1/members/{memberId}
----
...
=== 로그인
----
POST: http://www.bad-request.kr/api/v1/login
----
==== 요청
...
=== 로그아웃
----
POST: http://www.bad-request.kr/api/v1/logout
----
==== 요청
...
=== 토큰 재발급
----
POST: http://www.bad-request.kr/api/v1/refresh
----
==== 요청
...
----
POST: http://www.bad-request.kr/api/v1/board
----
...
=== 게시판 리스트 조회
----
GET: http://www.bad-request.kr/api/v1/board
----
==== 검색 조건 없이 검색
...
=== 게시판 상세 조회
----
GET: http://www.bad-request.kr/api/v1/board/{boardId}
----
==== 요청
...
----
GET: http://www.bad-request.kr/api/v1/dashboard/system
----
...
----
GET: http://www.bad-request.kr/api/v1/dashboard/heap
----
==== 요청
