...
public enum ApiResponseStatus {
    ...
    ACCESS_TOKEN_IS_EXPIRED(1206, "Access Token의 유효기간이 만료되었습니다.", HttpStatus.UNAUTHORIZED),
    REFRESH_TOKEN_IS_EXPIRED(1207, "Refresh Token의 유효기간이 만료되었습니다.", HttpStatus.UNAUTHORIZED),
