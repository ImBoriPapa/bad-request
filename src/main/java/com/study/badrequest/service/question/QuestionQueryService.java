...
public interface QuestionQueryService {
    ...
    QuestionDetail getQuestionDetail(HttpServletRequest request, HttpServletResponse response, Long questionId, CurrentLoggedInMember.Information information);
