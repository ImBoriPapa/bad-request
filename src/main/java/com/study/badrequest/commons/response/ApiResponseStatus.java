...
public enum ApiResponseStatus {
     ...
     * code: 1100~
     */
    WRONG_FILE_ERROR(1101, "잘못된 파일 형식입니다."),
    UPLOAD_FAIL_ERROR(1102, "파일 업로드에 실패했습니다."),
    NOT_SUPPORT_ERROR(1103, "지원하지 않는 파일 형식입니다."),
    TOO_BIG_PROFILE_IMAGE_SIZE(1104, "프로필 이미지 파일의 크기는 500KB이하만 가능합니다."),
    /**
     * 로그인 관련
     */
    IS_NOT_CONFIRMED_MAIL(1603, "이메일 인증 후 로그인 해주세요"),
    IS_EXPIRED_TEMPORARY_PASSWORD(1604, "만료된 임시 비밀번호입니다."),
    TOKEN_NOT_MATCH(1500, "저장된 토큰과 일치하지 않습니다."),
    TOKEN_IS_EMPTY(1501, "AccessToken 이 없습니다."),
    TOKEN_IS_EXPIRED(1502, "토큰의 유효기간이 만료되었S습니다."),
    ...
    //OAUTH2
    ALREADY_REGISTERED_OAUTH2_EMAIL(1700, "이미 등록된 이메일입니다."),
    ALREADY_REGISTERED_SELF_LOGIN_EMAIL(1701, "이미 자체 등록된 이메일입니다."),
    /**
     * 회원 관련
     * code: 2000~
     */
    ...
    WRONG_EMAIL_AUTHENTICATION_CODE(2005, "잘못된 이메일 인증 코드입니다."),
    NOTFOUND_AUTHENTICATION_EMAIL(2006, "인증 메일 요청 정보를 찾을수 없습니다. 이메일 혹은 인증메일 만료 시간을 확인해 주세요"),
    NEW_PASSWORD_CANNOT_BE_SAME_AS_CURRENT(2007, "새 비밀번호는 기존 비밀과 같을 수 없습니다."),
    NOT_MATCH_REQUEST_MEMBER_WITH_LOGGED_IN_MEMBER(2008, "요청된 회원과 로그인된 회원의 정보가 일치하지 않습니다."),
     ...
     * 질문
     */
    NOT_EXIST_SORT_VALUE(2500,"존재하지 않는 정렬 조건입니다."),
    NOT_EXIST_QUESTION_STATUS_VALUE(2501,"존재하지 않는 질문 상태 입니다."),
