...
public class ModifyQuestionTest extends QuestionServiceTestBase {
    ...
    void test2() throws Exception {
        ...
        Long questionId = 1324L;
        QuestionRequest.Modify request = new QuestionRequest.Modify();
        Member member = Member.createByEmail("email@email.com", "password", "01012341234",MemberProfile.createMemberProfile("",ProfileImage.createDefaultImage("")));
    ...
    void test3() throws Exception {
        ...
        Member questioner = Member.createByEmail("email@email.com", "password", "01012341234",MemberProfile.createMemberProfile("nickname", ProfileImage.createDefaultImage("image")));

        Member requester = Member.createByEmail("email@email.com", "password", "01012341234",MemberProfile.createMemberProfile("nickname", ProfileImage.createDefaultImage("image")));
