...
class MemberUnitTest {
    ...
    void 회원생성실퍠톄스트1() throws Exception {
        //given
    ...
    void 회원생성성공테스트() throws Exception {
        ...
        AuthenticationCodeGenerator codeGenerator = new TestAuthenticationCodeGenerator();
        ...
        assertThat(member.getAuthenticationCode()).isEqualTo(codeGenerator.generate());
